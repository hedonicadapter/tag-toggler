...
LOCATION=${2:-"eastus"}
SERVER_NAME="demo-mysql-server-$SUFFIX"
...
echo "==========================================="
echo " Azure Database for MySQL Runbook"
echo "==========================================="
...
echo "2. Deploying MySQL Flexible Server: $SERVER_NAME (Can take several minutes)"
...
# echo "3. Stopping MySQL Server..."
# az mysql flexible-server stop --resource-group $RG_NAME --name $SERVER_NAME
# echo "Server Stopped."

# echo "Waiting for 30 seconds..."
# sleep 20

# echo "4. Starting MySQL Server..."
# az mysql flexible-server start --resource-group $RG_NAME --name $SERVER_NAME
# echo "Server Started."
